...
train_sources = [
    "dataset_build/temp_fixed_production_run_4000.extxyz",
    "dataset_build/temp_fixed_production_run_18000.extxyz",
    "dataset_build/temp_fixed_production_run_28000.extxyz"
]

val_sources = [
    "dataset_build/temp_fixed_production_run_32000.extxyz"
]

test_sources = [
    "dataset_build/temp_fixed_production_run_46000.extxyz"
]
