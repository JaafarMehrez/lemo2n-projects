...
def preprocess_trajectory(traj_file, output_dir, dt_fs=5.0, frame_interval=1.0):
    """
    Args:
        traj_file: Path to LAMMPS dump
        dt_fs: Prediction horizon
        frame_interval: Time between dump frames in fs (0.001 ps = 1.0 fs)
    """
...
if __name__ == "__main__":
    ...
    for f in files:
        preprocess_trajectory(f, "dataset_build", dt_fs=5.0, frame_interval=1.0)
