...
from trajcast.data._keys import (
    POSITIONS_KEY, ATOMIC_NUMBERS_KEY, PBC_KEY, CELL_KEY, DISPLACEMENTS_KEY, VELOCITIES_KEY
)

ROOT = "./" 
FILENAME = "dump_1.lammpstrj"
...
traj = ASETrajectory.read_from_file(
    ...
    filename=FILENAME,
    wrapper="lammps",
    wrapper_kwargs={"lammps_units":"metal", "desired_units":"metal","type_mapping":{1:18}},
    index=":",
    apply_unwrapping=True, # that would only work for trajectories generated from NVT ensemble
...
traj.write_to_file(
    ...
    chosen_fields={POSITIONS_KEY,ATOMIC_NUMBERS_KEY, PBC_KEY, CELL_KEY, DISPLACEMENTS_KEY, VELOCITIES_KEY},
    format="extxyz"
)
